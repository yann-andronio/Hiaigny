...
export default function HeroSection() {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between py-20 bg-[#f5f5f5] relative overflow-hidden rounded-lg px-4 md:px-10">
            ...
            {/*  gauche */}
            <div className="flex-1 text-center md:text-left md:pr-8 mt-16 relative z-10" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="1000">
                <h1 className="text-5xl md:text-[3.3rem] font-extrabold text-[#22C55E] mb-4">
                ...
                <Link to="/teste" className="inline-block bg-[#22C55E] text-white text-lg px-8 py-3 rounded-full transition-transform duration-300 hover:scale-105 shadow-lg hover:shadow-2xl">
