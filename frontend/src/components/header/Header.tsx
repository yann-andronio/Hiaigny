...
export default function HeroSection() {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between py-20 bg-[#F5F5F5] relative overflow-hidden rounded-lg px-4 md:px-10">
            ...
            {/* Blobs en arrière-plan */}
            <img className={`${s.deco1} absolute  z-0 w-[300px] opacity-85`} src="./assets/image/deco/8.png" alt="Blob" />
            <img className="absolute bottom-[-80px] right-[-120px] z-0 w-[400px] opacity-85 "  src="./assets/image/deco/8.png"  alt="Blob" />

            {/* Section gauche */}
            <div className="flex-1 text-center md:text-left md:pr-8 relative z-10">
                ...
                <a href="#symptoms" className="inline-block bg-[#22C55E] text-white text-lg px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl">
            ...
            <div className="flex-1 flex justify-center mt-10 md:mt-0 relative z-10">
                <div className="w-full max-w-lg mx-auto md:mx-0" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
