    ...
    return (
        <Fragment>
            <div className="bg-[#F5F5F5] min-h-screen flex flex-col items-center justify-center text-center px-8">
                <h1 className="text-6xl font-bold text-[#22C55E] mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
                    <div className="bg-white shadow-lg rounded-lg p-6 text-center hover:bg-gray-50 transition-all duration-300 hover:scale-105">
                ...
                <div className="mt-16">
                    <button className="bg-gradient-to-r from-[#22C55E] to-[#ffbb33] text-white py-4 px-12 rounded-full text-xl shadow-lg hover:scale-105 hover:shadow-xl transition-transform duration-200">
